...
import (
	...
	"github.com/GoAsyncFunc/server-trojan/internal/app/server"
	_ "github.com/GoAsyncFunc/server-trojan/internal/pkg/dep"
...
func main() {
	...
	app := &cli.App{
		...
		Version:   Version,
		Copyright: CopyRight,
		Usage:     "Provide Trojan service for V2Board",
		Flags: []cli.Flag{
			&cli.StringFlag{
				Name:        "api",
			...
			&cli.StringFlag{
				...
				Value:       "/var/lib/server-trojan",
				DefaultText: "/var/lib/server-trojan",
				Required:    false,
				Destination: &dataDir,
			},
		},
